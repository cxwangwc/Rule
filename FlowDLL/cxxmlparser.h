...
class __declspec(dllexport) XMLNodeContents
{
public:
...
class __declspec(dllexport) ToXMLStringTool
{
public:
...
class __declspec(dllexport) XMLParserBase64Tool
{
public:
